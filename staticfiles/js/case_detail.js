class CaseDetailManager {
    ...
    populateFormData(data) {
        ...
        console.log('Received loan_type_choices:', data.loan_type_choices);
        console.log('Current loan_type:', data.loan_case.loan_type);
        ...
        if (loanTypeSelect) {
            loanTypeSelect.innerHTML = ''; // 기존 옵션 초기화
            ...
            loanTypeOptions.forEach(option => {
                ...
                loanTypeSelect.add(optionElement);
            });
            
            // 현재 대출 유형 설정
            if (data.loan_case.loan_type) {
        ...
        this.populateSelectOptions('loan_type', data.loan_type_choices, data.loan_case.loan_type);
    }
