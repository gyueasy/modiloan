    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', '관리자'), ('branch_manager', '지점장'), ('team_leader', '팀장'), ('staff', '직원')], default='staff', max_length=20, verbose_name='역할')),
                ('phone', models.CharField(blank=True, max_length=11, verbose_name='전화번호')),
